    ...
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <div className="space-y-5 text-lg leading-8 text-neutral-800">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <Link href="/watch-player-live/carlos-alcaraz" className="rounded-xl border p-4 font-medium hover:bg-neutral-50">
            Open live match hub for Carlos Alcaraz
          </Link>
          <Link href="/player/carlos-alcaraz" className="rounded-xl border p-4 font-medium hover:bg-neutral-50">
