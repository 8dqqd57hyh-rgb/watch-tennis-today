...
export default function Page() {
  ...
  return <main className="mx-auto max-w-5xl p-4 text-zinc-900">
    ...
    <section className="mt-8 rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
      <h2 className="text-2xl font-black">How to watch Wimbledon by country</h2>
      ...
      <div className="mt-4 flex flex-wrap gap-3"><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/how-to-watch-wimbledon-in-usa">How to watch Wimbledon in the USA</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/how-to-watch-wimbledon-in-uk">Wimbledon TV and streaming in the UK</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/how-to-watch-wimbledon-in-canada">How to watch Wimbledon in Canada</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/how-to-watch-wimbledon-in-australia">Wimbledon TV and streaming in Australia</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/how-to-watch-wimbledon-in-poland">How to watch Wimbledon in Poland</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/how-to-watch-wimbledon-in-germany">How to watch Wimbledon in Germany</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/how-to-watch-wimbledon-in-france">Wimbledon TV and streaming in France</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/how-to-watch-wimbledon-in-spain">How to watch Wimbledon in Spain</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/how-to-watch-wimbledon-in-italy">Wimbledon TV and streaming in Italy</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/how-to-watch-wimbledon-in-india">How to watch Wimbledon in India</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/where-to-watch-wimbledon">All Wimbledon broadcaster checks</Link></div>
    </section>
    <section className="mt-8 rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
