...
export const metadata: Metadata = {
  title: "US Open Live Stream, Schedule & Legal TV Guide | Watch Tennis Today",
  description: "A practical US Open hub with legal streaming notes, schedule context, player storylines and country-specific viewing guidance.",
  alternates: { canonical: "https://watchtennistoday.com/us-open" },
};

const faq = [
  { q: "Where can I watch US Open legally?", a: "Use official tournament broadcasters and licensed services in your country. Rights differ by market, so confirm coverage on the provider site before subscribing." },
  { q: "Does Tennis TV show US Open?", a: "Grand Slam rights are separate from regular ATP Tour rights. Tennis TV is useful for many ATP events, but Grand Slam coverage normally requires event-specific broadcasters." },
...
export default function Page() {
  const breadcrumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "US Open", item: "https://watchtennistoday.com/us-open" },
  ] };
  ...
  return <main className="mx-auto max-w-5xl p-4 text-zinc-900">
    ...
    <nav className="mb-6 flex flex-wrap gap-2 text-sm text-zinc-500"><Link href="/">Home</Link><span>/</span><span>US Open</span></nav>
    <section className="rounded-3xl bg-zinc-950 p-8 text-white">
      ...
      <h1 className="mt-3 text-4xl font-black md:text-6xl">US Open live stream, schedule and legal TV guide</h1>
      <p className="mt-5 max-w-3xl text-lg leading-8 text-zinc-300">Use this page as a calm, legal starting point for following US Open. We combine schedule context, country viewing notes, player storylines and internal links without promising streams we do not host or verify.</p>
    ...
    <section className="mt-8 grid gap-6 lg:grid-cols-[1.4fr_0.8fr]">
      <article className="space-y-5 rounded-3xl border border-zinc-200 bg-white p-6 text-sm leading-7 text-zinc-700 shadow-sm">
        ...
        <p>US Open is one of the major events that casual fans, committed tennis followers and search visitors all track differently. Some people arrive looking for a specific player, some want the order of play, and others only need to know which legal service carries the match in their country. This hub is designed to serve all three needs without turning the page into a thin list of links.</p>
        <p>The tournament is associated with New York, hard-court conditions and the late-summer part of the tennis calendar. Those details matter because viewing demand rises when a draw moves from early rounds into seeded clashes, night sessions, semifinals and finals. Instead of inventing live data when a feed is incomplete, this page points readers toward official schedule sources, player pages and legal streaming guides.</p>
        <p>The US Open is a high-demand event because of night sessions, American television windows and fast hard-court conditions. Fans often search for player-specific streams during the second week, so this hub prioritizes legal viewing checks and player links over unsupported promises.</p>
      ...
      <PlayerFollowCTA tournamentName="US Open" source="us-open-hub" />
    </section>
    <section id="how-to-watch" className="mt-8"><LegalStreamingOptions title="How to watch US Open legally" /></section>
    ...
    <section className="mt-8 rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-4 flex flex-wrap gap-3"><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/watch-tennis-in/usa">USA</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/watch-tennis-in/uk">UK</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/watch-tennis-in/australia">Australia</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/watch-tennis-in/canada">Canada</Link><Link className="rounded-2xl bg-zinc-100 px-4 py-3 font-bold" href="/watch-tennis-online">General legal guide</Link></div>
    </section>
    <section className="mt-8 rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
