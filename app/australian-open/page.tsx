...
export const metadata: Metadata = {
  title: "Australian Open Live Stream, Schedule & Legal TV Guide | Watch Tennis Today",
  description: "A practical Australian Open hub with legal streaming notes, schedule context, player storylines and country-specific viewing guidance.",
  alternates: { canonical: "https://watchtennistoday.com/australian-open" },
};

const faq = [
  { q: "Where can I watch Australian Open legally?", a: "Use official tournament broadcasters and licensed services in your country. Rights differ by market, so confirm coverage on the provider site before subscribing." },
  { q: "Does Tennis TV show Australian Open?", a: "Grand Slam rights are separate from regular ATP Tour rights. Tennis TV is useful for many ATP events, but Grand Slam coverage normally requires event-specific broadcasters." },
...
export default function Page() {
  const breadcrumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Australian Open", item: "https://watchtennistoday.com/australian-open" },
  ] };
  ...
  return <main className="mx-auto max-w-5xl p-4 text-zinc-900">
    ...
    <nav className="mb-6 flex flex-wrap gap-2 text-sm text-zinc-500"><Link href="/">Home</Link><span>/</span><span>Australian Open</span></nav>
    <section className="rounded-3xl bg-zinc-950 p-8 text-white">
      ...
      <h1 className="mt-3 text-4xl font-black md:text-6xl">Australian Open live stream, schedule and legal TV guide</h1>
      <p className="mt-5 max-w-3xl text-lg leading-8 text-zinc-300">Use this page as a calm, legal starting point for following Australian Open. We combine schedule context, country viewing notes, player storylines and internal links without promising streams we do not host or verify.</p>
    ...
    <section className="mt-8 grid gap-6 lg:grid-cols-[1.4fr_0.8fr]">
      <article className="space-y-5 rounded-3xl border border-zinc-200 bg-white p-6 text-sm leading-7 text-zinc-700 shadow-sm">
        ...
        <p>The Australian Open creates time-zone challenges for many fans. A helpful page should explain how to plan around overnight sessions, how to follow matches when live video is not available locally, and why official schedules matter before setting alerts.</p>
      ...
      <PlayerFollowCTA tournamentName="Australian Open" source="australian-open-hub" />
    </section>
    <section id="how-to-watch" className="mt-8"><LegalStreamingOptions title="How to watch Australian Open legally" /></section>
