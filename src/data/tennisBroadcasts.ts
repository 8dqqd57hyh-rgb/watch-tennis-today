...
const officialSources = {
  ...
  wbdUsOpenEurope: "https://media.wbdsports.com/post/us-open-tennis-comes-to-millions-of-viewers-across-europe-on-eur",
  eurosportPolandExpansion: "https://www.broadbandtvnews.com/2026/03/30/eurosport-3-and-4-to-launch-in-poland/",
  canalPlusWtaTransition: "https://www.press.pl/tresc/89371,canal--traci-prawa-do-wta-tour-z-igA-Swiatek_-kobiecy-tenis-od-2027-roku-w-eleven-sports",
  krritFreeToAirSlamFinals: "https://www.wirtualnemedia.pl/krrit-lista-waznych-wydarzen-darmowe-transmisje-sportowe-rozporzadzenie-tenis-hokej-liga-konferencji,7325153912088672a",
  bbcWimbledonExtension: "https://www.broadbandtvnews.com/2026/06/25/bbc-secures-wimbledon-rights-until-2033/",
  skyUsOpenExtension: "https://www.satandpcguy.com/2026/08/26/sky-keeps-us-open-tennis-rights-in-uk-until-2030/",
  tntSportsWikipedia: "https://en.wikipedia.org/wiki/Tennis_on_TNT_Sports",
};
...
const wbdUsOpenEuropeLink = { label: "WBD Sports: US Open across Europe on Eurosport/HBO Max", url: officialSources.wbdUsOpenEurope };
const eurosportPolandExpansionLink = { label: "Eurosport 3 and 4 launch in Poland (trade press)", url: officialSources.eurosportPolandExpansion };
const canalPlusWtaTransitionLink = { label: "Canal+ WTA rights end 2026; Eleven Sports from 2027 (trade press)", url: officialSources.canalPlusWtaTransition };
const krritFreeToAirLink = { label: "Poland free-to-air Grand Slam semifinal/final rule (trade press)", url: officialSources.krritFreeToAirSlamFinals };
const bbcWimbledonExtensionLink = { label: "BBC Wimbledon rights extension to 2033 (trade press)", url: officialSources.bbcWimbledonExtension };
const skyUsOpenExtensionLink = { label: "Sky UK US Open rights extension to 2030 (trade press)", url: officialSources.skyUsOpenExtension };
const tntSportsWikipediaLink = { label: "TNT Sports UK tennis rights overview", url: officialSources.tntSportsWikipedia };
...
export const tennisBroadcastDatabase: TennisCountryBroadcastDatabase[] = [
  country("Poland", "PL", [
    slamService("australian-open", { broadcasterName: "Eurosport", streamingServiceName: "Eurosport 1-4 / HBO Max / Player", extraLinks: [eurosportLink, eurosportPolandExpansionLink], coverageNotes: "Eurosport carries Grand Slam tennis in Poland across its Eurosport 1-4 channel lineup (Eurosport 3 and 4 launched in Poland in 2026) plus HBO Max and Player streaming. Confirm Poland-specific Australian Open coverage on the official directory before paying.", confidenceLevel: "partial", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: "unknown", supportedDevices: defaultDevices }),
    slamService("roland-garros", { broadcasterName: "Eurosport", streamingServiceName: "Eurosport 1-4 / HBO Max / Player", extraLinks: [eurosportLink, eurosportPolandExpansionLink], coverageNotes: "Roland Garros publishes yearly broadcaster information; Eurosport's Polish channel lineup and HBO Max/Player streaming are the reported route, but verify Poland specifically on the current broadcaster article.", confidenceLevel: "partial", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: "unknown", supportedDevices: defaultDevices }),
    slamService("wimbledon", { broadcasterName: "Not independently confirmed for the current year", streamingServiceName: "Check the official Wimbledon broadcaster list for Poland", coverageNotes: "We could not confirm Poland's current Wimbledon rights holder from a primary or reliable trade source this review cycle. Use Wimbledon's official TV coverage page to confirm the current Polish broadcaster before assuming any provider carries it.", confidenceLevel: "needs_check", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: false, supportedDevices: defaultDevices, lastVerified: "2026-09-17" }),
    slamService("us-open", { broadcasterName: "Eurosport", streamingServiceName: "Eurosport 1-4 / HBO Max / Player", extraLinks: [eurosportLink, wbdUsOpenEuropeLink, eurosportPolandExpansionLink, krritFreeToAirLink], coverageNotes: "Warner Bros. Discovery's own US Open coverage release lists Poland among the European markets carried on Eurosport and HBO Max, alongside the Player platform locally. A Polish public-broadcaster (TVP) simulcast may also be required by regulation for Grand Slam semifinals and finals involving Polish players; the exact fulfilling channel for 2026 was not confirmed.", confidenceLevel: "confirmed", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: "unknown", supportedDevices: defaultDevices, lastVerified: "2026-09-17" }),
    atpService({ broadcasterName: "Polsat Sport", streamingServiceName: "Polsat Box Go / Tennis TV", coverageNotes: "Polish sports-media coverage reports Polsat Sport (streaming via Polsat Box Go) alongside Tennis TV for ATP Tour events, though we could not locate a single primary press release confirming this. ATP Tour rights are separate from Grand Slams and WTA, so verify the selected tournament and court feed.", confidenceLevel: "partial", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: false, supportedDevices: defaultDevices, lastVerified: "2026-09-17" }),
    wtaService({ broadcasterName: "CANAL+ Sport (through end of 2026); Eleven Sports from 2027", streamingServiceName: "CANAL+ Sport streaming through 2026, then Eleven Sports", extraLinks: [canalPlusWtaTransitionLink], coverageNotes: "Polish trade press (press.pl, 18 Sep 2025) confirms CANAL+ Sport holds Polish WTA Tour rights through the end of 2026, after which exclusive rights move to Eleven Sports (Polsat Plus Group) for 2027-2031. Confirm the current season's provider before subscribing, since this changes at the end of 2026.", confidenceLevel: "confirmed", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: "unknown", supportedDevices: defaultDevices, lastVerified: "2026-09-17" }),
  ]),
  country("United Kingdom", "GB", [
    slamService("australian-open", { broadcasterName: "TNT Sports", streamingServiceName: "discovery+ / TNT Sports access", extraLinks: [eurosportLink, tntSportsWikipediaLink], coverageNotes: "TNT Sports (Warner Bros. Discovery) is reported as the UK Australian Open rights holder. Check the AO directory for the UK and confirm whether the selected app includes every court and replays.", confidenceLevel: "partial", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: true, supportedDevices: defaultDevices, lastVerified: "2026-09-17" }),
    slamService("roland-garros", { broadcasterName: "TNT Sports", streamingServiceName: "discovery+ / TNT Sports access", extraLinks: [tntSportsWikipediaLink], coverageNotes: "TNT Sports holds UK Roland Garros rights under a pan-European Warner Bros. Discovery deal reported to run through 2034. Verify UK coverage on the current Roland Garros broadcaster article and the TNT or discovery+ schedule before paying.", confidenceLevel: "partial", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: true, supportedDevices: defaultDevices, lastVerified: "2026-09-17" }),
    slamService("wimbledon", { broadcasterName: "BBC", streamingServiceName: "BBC iPlayer", price: knownPrice(0, "GBP", "No streaming subscription fee listed; UK TV Licence rules may apply"), extraLinks: [bbcWimbledonExtensionLink], coverageNotes: "Wimbledon lists UK coverage through the BBC, free-to-air with a UK TV Licence. Trade press reports a BBC rights extension to 2033, though we could not fetch the AELTC/BBC press release directly, so treat that specific end date as high-confidence rather than primary-verified. Check the BBC schedule and iPlayer for live courts and replays.", confidenceLevel: "confirmed", isFree: true, requiresSubscription: false, replaysAvailable: "unknown", englishCommentary: true, supportedDevices: defaultDevices, lastVerified: "2026-09-17" }),
    slamService("us-open", { broadcasterName: "Sky Sports", streamingServiceName: "NOW / Sky Go", price: knownPrice(34.99, "GBP", "NOW Sports Month Membership: GBP 34.99/month"), extraLinks: [nowGbLink, skyUsOpenExtensionLink], coverageNotes: "Sky holds exclusive UK/Ireland US Open rights, reported extended through 2030. Confirm match sessions on Sky Sports or NOW before subscribing; exact current pricing should be checked on Sky/NOW's own page.", confidenceLevel: "confirmed", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: true, supportedDevices: nowDevices, lastVerified: "2026-09-17" }),
    atpService({ broadcasterName: "Sky Sports", streamingServiceName: "NOW / Sky Go", price: knownPrice(34.99, "GBP", "NOW Sports Month Membership: GBP 34.99/month"), extraLinks: [skyAtpWtaLink, nowGbLink], coverageNotes: "Sky's official 2024 announcement confirms a multi-year UK and Ireland ATP and WTA tour partnership; trade press separately reports a 2026 extension. Tennis TV can still matter for ATP, but blackouts and Sky coverage should be checked.", confidenceLevel: "confirmed", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: true, supportedDevices: nowDevices }),
    wtaService({ broadcasterName: "Sky Sports", streamingServiceName: "NOW / Sky Go", price: knownPrice(34.99, "GBP", "NOW Sports Month Membership: GBP 34.99/month"), extraLinks: [skyAtpWtaLink, nowGbLink], coverageNotes: "Sky is the main WTA tour route in the UK under its official ATP/WTA partnership; verify the weekly tournament schedule before paying.", confidenceLevel: "confirmed", isFree: false, requiresSubscription: true, replaysAvailable: "unknown", englishCommentary: true, supportedDevices: nowDevices }),
  ]),
