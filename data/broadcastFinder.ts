...
export const broadcastCountries: BroadcastCountry[] = [
  {
    ...
    countryCode: "PL",
    country: "Poland",
    primaryBroadcasters: ["CANAL+ Sport", "Eurosport", "Polsat Sport", "Tennis TV"],
    grandSlamBroadcasters: ["Eurosport (1-4) / HBO Max / Player for the Australian Open, Roland Garros and US Open", "Wimbledon rights holder not independently confirmed for the current year", "official tournament broadcaster lists"],
    atpOptions: ["Polsat Sport / Polsat Box Go", "Tennis TV", "ATP official TV schedule"],
    wtaOptions: ["CANAL+ Sport (through end of 2026)", "Eleven Sports (from 2027)", "WTA official where-to-watch directory"],
    officialDirectories: [
      ...
      { label: "US Open across Europe (Eurosport/HBO Max, incl. Poland)", url: "https://media.wbdsports.com/post/us-open-tennis-comes-to-millions-of-viewers-across-europe-on-eur" },
      { label: "CANAL+ WTA rights end 2026; Eleven Sports from 2027 (trade press)", url: "https://www.press.pl/tresc/89371,canal--traci-prawa-do-wta-tour-z-igA-Swiatek_-kobiecy-tenis-od-2027-roku-w-eleven-sports" },
    ],
    ...
    localContext: "In Poland, tennis fans need to separate regular tour coverage from Grand Slam coverage. Eurosport (with its Poland-specific Eurosport 1-4 channel lineup expanded in 2026) plus HBO Max and the Player app are the confirmed route for the US Open, and are reported for the Australian Open and Roland Garros as well. WTA Tour rights sit with CANAL+ Sport through the end of 2026, after which they move to Eleven Sports for 2027-2031. ATP Tour coverage is reported via Polsat Sport and Tennis TV. We could not independently confirm Poland's current Wimbledon broadcaster, so check the official Wimbledon TV coverage page directly for that event.",
    verificationAdvice: "Before match time, compare the tournament order of play with Eurosport/HBO Max/Player, CANAL+ Sport or Eleven Sports (depending on the season), Polsat Sport and the ATP/WTA listings. If the match is a Grand Slam, verify the tournament's own broadcaster page, since Wimbledon coverage in Poland was not confirmed in this review and Grand Slam rights generally do not match normal ATP or WTA coverage. Under Polish broadcast regulation, Grand Slam singles semifinals and finals involving Polish players may also be required to air free-to-air; the specific channel fulfilling that obligation was not confirmed for 2026.",
    localViewingTips: [
      "Check whether the current season places WTA coverage with CANAL+ Sport (through 2026) or Eleven Sports (from 2027) before assuming your existing subscription still applies.",
      "For the US Open, Eurosport's expanded Poland lineup (Eurosport 1-4) plus HBO Max and Player are the confirmed 2026 route.",
      "If a Grand Slam match involves a Polish player in the semifinals or final, check local free-to-air listings in addition to your pay-TV or streaming app.",
    ],
    majorEventNotes: [
      "Wimbledon: current Polish rights holder not independently confirmed as of this review; check wimbledon.com's official TV coverage page directly.",
      "WTA Tour: rights move from CANAL+ Sport to Eleven Sports starting in 2027; this page will need re-verification once that transition takes effect.",
    ],
  },
  {
    slug: "usa",
  ...
  },
  {
    ...
    grandSlamBroadcasters: ["BBC (Wimbledon, free-to-air)", "Sky Sports (US Open)", "TNT Sports / discovery+ (Australian Open, Roland Garros)", "official tournament broadcaster lists"],
    atpOptions: ["Sky Sports / NOW", "Tennis TV", "ATP official TV schedule"],
    wtaOptions: ["Sky Sports / NOW", "WTA official where-to-watch directory"],
    officialDirectories: [
      { label: "ATP TV Schedule", url: "https://www.atptour.com/en/tournaments/tv-schedule" },
      { label: "WTA Where to Watch", url: "https://www.wtatennis.com/where-to-watch-tennis" },
      { label: "Wimbledon TV Coverage", url: "https://www.wimbledon.com/en_GB/the_championships/tv_coverage" },
      { label: "Sky: ATP and WTA tour partnership announcement", url: "https://www.skygroup.sky/article/sky-secures-new-partnerships-for-the-atp-and-wta-tours-which-will-see-year-round-tennis-for-fans-on-sky-sports" },
    ],
    ...
    localContext: "In the United Kingdom, Wimbledon is free-to-air on the BBC (with a UK TV Licence) and should be treated separately from regular ATP and WTA weeks. Sky Sports holds the UK/Ireland ATP and WTA tour partnership plus the US Open, while TNT Sports (Warner Bros. Discovery) is reported to hold the Australian Open and Roland Garros. Tennis TV can still matter for individual ATP events depending on Sky's coverage. The important check is whether the match belongs to a tour event, a Grand Slam, Davis Cup/Billie Jean King Cup, or another competition with separate rights, since each can sit with a different broadcaster.",
    verificationAdvice: "Use the official Wimbledon, ATP and WTA directories first, then confirm against the broadcaster's live schedule (BBC for Wimbledon, Sky Sports/NOW for the US Open and tour events, TNT Sports/discovery+ for the Australian Open and Roland Garros). If the match is listed only as a score feed, video may still require a different rights package. Reported multi-year rights extensions (BBC to 2033, Sky's US Open deal to 2030) come from trade press, not a primary press release we could fetch directly, so treat specific end dates as high-confidence rather than fully verified.",
    localViewingTips: [
      "Wimbledon: BBC iPlayer and BBC TV, free with a UK TV Licence.",
      "US Open and weekly ATP/WTA tour events: Sky Sports or the NOW Sports add-on.",
      "Australian Open and Roland Garros: TNT Sports or discovery+.",
    ],
    majorEventNotes: [
      "Sky's UK/Ireland ATP and WTA tour partnership is confirmed via Sky's own 2024 announcement; a further extension reported in 2026 trade press was not independently verified.",
      "TNT Sports' Australian Open and Roland Garros UK rights are sourced to secondary reporting (Wikipedia-summarised trade coverage), not a primary WBD/TNT release located in this review.",
    ],
  },
  {
    slug: "germany",
